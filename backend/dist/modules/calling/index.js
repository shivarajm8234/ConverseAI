...
async function getPublicIP() {
    try {
        ...
        console.error('⚠️ Failed to fetch public IP automatically:', error.message);
        return null;
    }
}
...
// Outbound AI Call
export const initiateOutboundCall = async (phoneNumber, name) => {
    if (!client) {
...
export const handleCallTranscript = async (callId, customerId, transcript) => {
...
export const forwardCall = (ctx, targetNumber) => {
